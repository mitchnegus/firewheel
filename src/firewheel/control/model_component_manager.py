...
class ModelComponentManager:
            ...
            while changed is True:
                ...
                while len(mc_depends_components) > 0:
                    ...
                    if inner_loops > 1000:
                        ...
                        raise RuntimeError(
                            "Apparent mc_depends_components infinite loop"
                        )
                    changed = True
                    for component, parent, grouping in mc_depends_components:
                        did_insert = self.dg.insert(
                            component, grouping, duplicate=False
                        )
                ...
                grouped_entity_list = self.dg.get_ordered_entity_list_with_grouping()
                for component, grouping in grouped_entity_list:
                    ...
                    for attr in attr_precedes:
                        ...
                        try:
                            ...
                            for mcdep_name in mc_depends:
                                ...
                                mc_depends_components.append(
                                    (mcdep, component, grouping)
                                )
    ...
    def build_experiment_graph(self):  # noqa: DOC502
        ...
        progress_group = Group(mc_progress, ModelComponent.default_image_cache_progress)
